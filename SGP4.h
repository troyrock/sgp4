...
public:
    ...
    /**
     * @brief Dynamically update the B* drag parameter for current propagation.
     * @param bstar The new B* value to use.
     */
    void UpdateBStar(double bstar);

    /**
     * @brief Dynamically update the mean motion and other elements.
     */
    void UpdateElements(double n, double e, double bstar);

    /**
     * @brief Apply an along-track bias correction (radians).
     */
